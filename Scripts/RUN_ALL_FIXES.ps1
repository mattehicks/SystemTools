...
Write-Host "System - COMPLETE SLEEP/WAKE REPAIR SUITE" -ForegroundColor Cyan
Write-Host "------------------------------------------------------------" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "1. Disable broken Killer WiFi + Realtek Ethernet (Win11Win10 casualties)" -ForegroundColor White
